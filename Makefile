...
# Project:  one1.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -o Makefile one1.pro
#############################################################################
...
Makefile: one1.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/one1.0.0 || mkdir -p .tmp/one1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/one1.0.0/ && $(COPY_FILE) --parents mainwindow.h uart.h mythread.h .tmp/one1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp mythread.cpp .tmp/one1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/one1.0.0/ && (cd `dirname .tmp/one1.0.0` && $(TAR) one1.0.0.tar one1.0.0 && $(COMPRESS) one1.0.0.tar) && $(MOVE) `dirname .tmp/one1.0.0`/one1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/one1.0.0
...
moc_mythread.cpp: /usr/include/qt5/QtCore/QThread \
		/usr/include/qt5/QtCore/qthread.h \
		/usr/include/qt5/QtCore/qobject.h \
		/usr/include/qt5/QtCore/qobjectdefs.h \
		/usr/include/qt5/QtCore/qnamespace.h \
		...
		/usr/include/qt5/QtCore/qobject_impl.h \
		mythread.h
	/usr/lib/i386-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/i386-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/i686-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/i686-linux-gnu/4.8/include-fixed -I/usr/include/i386-linux-gnu -I/usr/include mythread.h -o moc_mythread.cpp
