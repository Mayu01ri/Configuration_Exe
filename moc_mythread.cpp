...
QT_MOC_LITERAL(3, 21, 5)
    ...
    "MyThread\0MsgChanged\0\0char*\0"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->MsgChanged((*reinterpret_cast< char*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyThread::*_t)(char * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::MsgChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyThread::MsgChanged(char * _t1)
{
